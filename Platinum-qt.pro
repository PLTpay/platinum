...
HEADERS += src/qt/platinumgui.h \
    ...
    src/qt/platinumaddressvalidator.h \
    src/alert.h \
...
SOURCES += src/qt/platinum.cpp src/qt/platinumgui.cpp \
    ...
    src/qt/platinumaddressvalidator.cpp \
    src/alert.cpp \
    ...
    src/qt/platinumstrings.cpp \
    src/qt/platinumamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/platinum.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/platinum_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/platinum-qt.rc
...
windows:RC_FILE = src/qt/res/platinum-qt.rc
